...
public sealed class PersonAddRequestValidator : AbstractValidator<PersonAddRequest>
{
	public PersonAddRequestValidator(IOptionsMonitor<PersonValidationOptions> personValidationOptions)
	{
